...
class SearchController extends Controller
{
    ...
    public function index(SearchRequest $request)
    {
        ...
        foreach ($cabinSearchResult as $cabin){
        ...
        return view('searchResult', ['cabinSearchResult' => $cabinSearchResult, 'holidayDates' => $holidayDates, 'greenDates' => $available_dates, 'orangeDates' => $orangeDates, 'redDates' => $not_available_dates, 'not_season_time' => $not_season_time]);
    }
