                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:390px;" width="100%" class="mcnTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-left:18px; padding-bottom:9px; padding-right:18px;">
                                                                ...
                                                                <img data-file-id="790305" height="246" src="https://gallery.mailchimp.com/74db297990c8f0bfe53f4cfa1/images/ce06e5fb-2670-4a0a-a969-aa9d71459c2c.png" style="border: 0px  ; width: 500px; height: 246px; margin: 0px;" width="500">
                                                            </td>
                                                        </tr>
                                                        </tbody></table>
                                                    <!--[if mso]>
                                                    ...
                                                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                                        <tbody><tr>
                                                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                                                ...
                                                                <img align="center" alt="" src="https://gallery.mailchimp.com/74db297990c8f0bfe53f4cfa1/images/1c7cde82-0d3a-4acd-8c60-826878eac4a4.jpg" width="564" style="max-width:800px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                <p>Sehr geehrter Gast, <br>
                                                                    <br>
                                                                    <br />You are receiving this email because we received a password reset request for your account.
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <a href="{{url('/reset/password', $passwordReset['token'])}}" target="_blank">Reset Password</a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                    ...
                    <tr>
                        <td align="center" valign="top" id="templateFooter">
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
                                <tr>
                                    <td valign="top" class="footerContainer"><table class="mcnFollowBlock" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    ...
                                                    <table class="mcnFollowContentContainer" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tbody><tr>
                                                            <td style="padding-left:9px;padding-right:9px;" align="center">
                                                                <table class="mcnFollowContent" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    <tbody><tr>
                                                                                                    ...
                                                                                                    <table class="mcnFollowContentItem" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                        <tbody><tr>
                                                                                                            <td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" valign="middle" align="left">
                                                                                                                <table border="0" cellpadding="0" cellspacing="0" width="" align="left">
                                                                                                                    <tbody><tr>

                                                                                                                        <td class="mcnFollowIconContent" valign="middle" width="24" align="center">
                                                                                                                            <a href="https://mobile.twitter.com/huettenholiday" target="_blank"><img src="http://cdn-images.mailchimp.com/icons/social-block-v2/color-twitter-48.png" style="display:block;" class="" height="24" width="24"></a>
                                                                                                                        </td>
                                                                                                            ...
                                                                                                            <td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" valign="middle" align="left">
                                                                                                                <table border="0" cellpadding="0" cellspacing="0" width="" align="left">
                                                                                                                    <tbody><tr>
                                                                                                                        ...
                                                                                                                        <td class="mcnFollowIconContent" valign="middle" width="24" align="center">
                                                                                                                            <a href="https://www.facebook.com/HuettenHoliday" target="_blank"><img src="http://cdn-images.mailchimp.com/icons/social-block-v2/color-facebook-48.png" style="display:block;" class="" height="24" width="24"></a>
                                                                                                                        </td>
                                                                                                            ...
                                                                                                            <td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" valign="middle" align="left">
                                                                                                                <table border="0" cellpadding="0" cellspacing="0" width="" align="left">
                                                                                                                    <tbody><tr>
                                                                                                                        ...
                                                                                                                        <td class="mcnFollowIconContent" valign="middle" width="24" align="center">
                                                                                                                            <a href="http://www.huetten-holiday.de" target="_blank"><img src="http://cdn-images.mailchimp.com/icons/social-block-v2/color-link-48.png" style="display:block;" class="" height="24" width="24"></a>
                                                                                                                        </td>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                <em>Copyright © 2017 Huetten-Holiday.de GmbH, All rights reserved.</em><br>
                                                                <br>

                                                                Huetten-Holiday.de GmbH<br>
                                                                Geschaeftsfuehrer: Michael Hofer<br>
                                                                Nebelhornstraße 3<br>
                                                                ...
                                                                service@huetten-holiday.de<br>
                                                                <br>
                                                                Unser vollständiges Impressum finden Sie hier:&nbsp;<br>
                                                                <a href="http://www.huetten-holiday.de/cms/index/legal" target="_blank">http://www.huetten-holiday.de/cms/index/legal</a><br>
                                                                <br>
